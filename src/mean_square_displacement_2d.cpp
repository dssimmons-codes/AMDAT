...
Mean_Square_Displacement_2D::~Mean_Square_Displacement_2D() = default;
...
Mean_Square_Displacement_2D::Mean_Square_Displacement_2D(System*sys,string orientation):Mean_Square_Displacement_2D()
{
