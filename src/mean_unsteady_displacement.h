...
#ifndef MEAN_UNSTEADY_DISPLACEMENT
#define MEAN_UNSTEADY_DISPLACEMENT
...
class Mean_Unsteady_Displacement: public Analysis
{
    int n_times;
    Coordinate * md;
    int * weighting;
  ...
  public:
    Mean_Unsteady_Displacement();			//default constructor
    Mean_Unsteady_Displacement(const Mean_Unsteady_Displacement &);		//copy constructor
    Mean_Unsteady_Displacement(System*);
    Mean_Unsteady_Displacement operator = (const Mean_Unsteady_Displacement &);	//assignment
