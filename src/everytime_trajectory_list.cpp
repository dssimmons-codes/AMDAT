/*Methods for Everytime_Trajectory_List class - stores a list of trajectories that is the same for all times*/
...
Everytime_Trajectory_List::Everytime_Trajectory_List()
{
...
Everytime_Trajectory_List::Everytime_Trajectory_List(System* syst, int capacity)
{
  int timeii;
...
void Everytime_Trajectory_List::reset(System* syst, int cap)
{
  int timeii;
...
void Everytime_Trajectory_List::write_count(string filename)const
{
