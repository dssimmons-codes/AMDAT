...
displacement_distribution.o version.h boolean_list.o fast_particles.o   displacement_map.o composition.o n_fold_order_parameter.o trajectory_list_bins.o structure_factor.o trajectory_list_decay.o vector_autocorrelation.o error.o gyration_radius.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o
	$(CXX) $(CFLAGSmain) amdat.o tokenize.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o stiffness_dist.o non_gaussian_parameter.o gaussian_comparison.o radial_debye_waller.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o  static_trajectory_list.o clustered_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o \
	displacement_distribution.o boolean_list.o fast_particles.o   composition.o n_fold_order_parameter.o displacement_map.o trajectory_list_bins.o structure_factor.o vector_autocorrelation.o trajectory_list_decay.o error.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o gyration_radius.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o   displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o -o AMDAT -lfftw3 -lm 
