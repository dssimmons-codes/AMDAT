...
ifeq ($(SERVER),TACC)
AMDAT: amdat.o tokenize.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o stiffness_dist.o gaussian_comparison.o fast_particles.o non_gaussian_parameter.o  gaussian_comparison.o radial_debye_waller.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o static_trajectory_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o displacement_distribution.o version.h \
boolean_list.o fast_particles.o   displacement_map.o composition.o n_fold_order_parameter.o trajectory_list_bins.o structure_factor.o clustered_list.o trajectory_list_decay.o vector_autocorrelation.o error.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o gyration_radius.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o \
analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o neighbor_list.o distance_neighbor_list.o
	$(CXX) $(CFLAGSmain) amdat.o tokenize.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o  wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o stiffness_dist.o non_gaussian_parameter.o gaussian_comparison.o radial_debye_waller.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o  static_trajectory_list.o clustered_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o \
	displacement_distribution.o boolean_list.o fast_particles.o composition.o n_fold_order_parameter.o displacement_map.o trajectory_list_bins.o structure_factor.o vector_autocorrelation.o trajectory_list_decay.o error.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o gyration_radius.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o \
	analysis_onetime.o radial_distribution_function.o  bond_autocorrelation_function.o displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o neighbor_list.o distance_neighbor_list.o -o AMDAT 
...
control.o: control.cpp control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h size_statistics.h provisional_multibodies.h dynamic_cluster_multibodies.h string_multibodies.h comover_multibodies.h relative_displacement_strings.h neighbor_list.h distance_neighbor_list.h
	$(CXX) $(CFLAGS) control.cpp -DTACC
else
AMDAT: amdat.o tokenize.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o stiffness_dist.o gaussian_comparison.o fast_particles.o non_gaussian_parameter.o  gaussian_comparison.o radial_debye_waller.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o static_trajectory_list.o clustered_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o \
displacement_distribution.o version.h boolean_list.o fast_particles.o   displacement_map.o composition.o n_fold_order_parameter.o trajectory_list_bins.o structure_factor.o trajectory_list_decay.o vector_autocorrelation.o error.o gyration_radius.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o displacement_list.o \
orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o neighbor_list.o distance_neighbor_list.o
	$(CXX) $(CFLAGSmain) amdat.o tokenize.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o stiffness_dist.o non_gaussian_parameter.o gaussian_comparison.o radial_debye_waller.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o  static_trajectory_list.o clustered_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o \
	displacement_distribution.o boolean_list.o fast_particles.o   composition.o n_fold_order_parameter.o displacement_map.o trajectory_list_bins.o structure_factor.o vector_autocorrelation.o trajectory_list_decay.o error.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o gyration_radius.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o \
	displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o neighbor_list.o distance_neighbor_list.o -o AMDAT -lfftw3 -lm 
...
control.o: control.cpp control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h   tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h multibody_region.h coordinate.h size_statistics.h provisional_multibodies.h dynamic_cluster_multibodies.h string_multibodies.h comover_multibodies.h relative_displacement_strings.h neighbor_list.h distance_neighbor_list.h
...
analysis_onetime.o: analysis_onetime.cpp analysis_onetime.h system.h atom_trajectory.h coordinate.h molecule.h analysis.h trajectory.h trajectory_list.h
	$(CXX) $(CFLAGS) analysis_onetime.cpp
...
gyration_radius.o: gyration_radius.cpp gyration_radius.h multibody_analysis.h multibody_list.h system.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h multibody.h multibody_set.h version.h
	$(CXX) $(CFLAGS) gyration_radius.cpp
...
bond_autocorrelation_function.o: bond_autocorrelation_function.cpp bond_autocorrelation_function.h multibody_analysis.h multibody_list.h system.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h multibody.h multibody_set.h version.h
	$(CXX) $(CFLAGS) bond_autocorrelation_function.cpp
...
edge_detector_timedependent.o: edge_detector_timedependent.cpp edge_detector_timedependent.h system.h coordinate.h analysis.h version.h molecule.h  atom_trajectory.h coordinate.h tokenize.h trajectory.h trajectory_set.h
	$(CXX) $(CFLAGS) edge_detector_timedependent.cpp
...
mean_velocity_unsteady.o: mean_velocity_unsteady.cpp mean_velocity_unsteady.h system.h coordinate.h version.h static_trajectory_list.h analysis.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h trajectory_set.h
	$(CXX) $(CFLAGS) mean_velocity_unsteady.cpp
...
mean_unsteady_displacement.o: mean_unsteady_displacement.cpp mean_unsteady_displacement.h system.h molecule.h atom_trajectory.h coordinate.h analysis.h  trajectory.h trajectory_list.h
	$(CXX) $(CFLAGS) mean_unsteady_displacement.cpp
...
radial_distribution_function.o: radial_distribution_function.cpp radial_distribution_function.h analysis_onetime.h system.h atom_trajectory.h coordinate.h molecule.h analysis.h trajectory.h trajectory_list.h version.h
	$(CXX) $(CFLAGS) radial_distribution_function.cpp
...
displacement_list.o: displacement_list.cpp displacement_list.h static_trajectory_list.h value_list.h analysis.h boolean_list.h trajectory_list.h system.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h trajectory_set.h
	$(CXX) $(CFLAGS) displacement_list.cpp
...
orientational_correlation.o: orientational_correlation.cpp orientational_correlation.h multibody_analysis.h multibody_list.h system.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h multibody.h multibody_set.h version.h
	$(CXX) $(CFLAGS) orientational_correlation.cpp
...
size_statistics.o:size_statistics.cpp size_statistics.h system.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h multibody.h multibody_set.h multibody_analysis.h version.h
	$(CXX) $(CFLAGS) size_statistics.cpp
...
multibody_region.o: multibody_region.cpp multibody_region.h system.h molecule.h analysis.h atom_trajectory.h coordinate.h tokenize.h trajectory.h multibody.h multibody_set.h multibody_analysis.h version.h
	$(CXX) $(CFLAGS) multibody_region.cpp
...
provisional_multibodies.o: provisional_multibodies.cpp provisional_multibodies.h multibody_set.h trajectory.h coordinate.h system.h analysis.h atom_trajectory.h tokenize.h trajectory_set.h multibody.h control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h   tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h\
 radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h multibody_region.h coordinate.h size_statistics.h
	$(CXX) $(CFLAGS) provisional_multibodies.cpp

dynamic_cluster_multibodies.o: dynamic_cluster_multibodies.h dynamic_cluster_multibodies.cpp provisional_multibodies.cpp provisional_multibodies.h multibody_set.h trajectory.h coordinate.h system.h analysis.h atom_trajectory.h tokenize.h trajectory_set.h multibody.h control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h   tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h\
 radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h multibody_region.h coordinate.h size_statistics.h
	$(CXX) $(CFLAGS) dynamic_cluster_multibodies.cpp

string_multibodies.o: string_multibodies.h string_multibodies.cpp dynamic_cluster_multibodies.h provisional_multibodies.cpp provisional_multibodies.h multibody_set.h trajectory.h coordinate.h system.h analysis.h atom_trajectory.h tokenize.h trajectory_set.h multibody.h control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h   tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h\
 radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h multibody_region.h coordinate.h size_statistics.h
	$(CXX) $(CFLAGS) string_multibodies.cpp

comover_multibodies.o: comover_multibodies.h comover_multibodies.cpp dynamic_cluster_multibodies.h provisional_multibodies.cpp provisional_multibodies.h multibody_set.h trajectory.h coordinate.h system.h analysis.h atom_trajectory.h tokenize.h trajectory_set.h multibody.h control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h   tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h\
 radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h multibody_region.h coordinate.h size_statistics.h
	$(CXX) $(CFLAGS) comover_multibodies.cpp

relative_displacement_strings.o: relative_displacement_strings.h relative_displacement_strings.cpp dynamic_cluster_multibodies.h provisional_multibodies.cpp provisional_multibodies.h multibody_set.h trajectory.h coordinate.h system.h analysis.h atom_trajectory.h tokenize.h trajectory_set.h multibody.h control.h system.h van_hove_self.h mean_square_displacement.h van_hove_distinct.h molecule.h atom_trajectory.h coordinate.h analysis.h debyewaller_dist.h stiffness_dist.h non_gaussian_parameter.h gaussian_comparison.h fast_particles.h   tokenize.h radial_debye_waller.h mean_square_displacement_2d.h velocity_autocorrelation.h strings.h rgtensor_stats.h displacement_map.h trajectory_list_bins.h bin_dynamics_analysis.h bin_static_analysis.h composition.h n_fold_order_parameter.h trajectory_list_decay.h multibody_set.h multibody.h multibody_list.h multibody_analysis.h gyration_radius.h trajectory_set.h edge_detector_timedependent.h mean_velocity_unsteady.h mean_unsteady_displacement.h\
 radial_distribution_function.h bond_autocorrelation_function.h orientational_correlation.h multibody_region.h coordinate.h size_statistics.h
	$(CXX) $(CFLAGS) relative_displacement_strings.cpp

neighbor_list.o: neighbor_list.cpp neighbor_list.h trajectory_list.h system.h trajectory_list.h trajectory_list.cpp analysis.h system.h atom_trajectory.h coordinate.h molecule.h trajectory.h
	$(CXX) $(CFLAGS) neighbor_list.cpp

distance_neighbor_list.o: distance_neighbor_list.cpp distance_neighbor_list.h neighbor_list.h trajectory_list.h system.h trajectory_list.h trajectory_list.cpp analysis.h system.h atom_trajectory.h coordinate.h molecule.h trajectory.h analysis_onetime.h coordinate.h molecule.h
	$(CXX) $(CFLAGS) distance_neighbor_list.cpp

clean: 
	rm -f amdat.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o non_gaussian_parameter.o gaussian_comparison.o gaussian_comparison.o fast_particles.o radial_debye_waller.o tokenize.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o static_trajectory_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o displacement_distribution.o \
	boolean_list.o value_list.o displacement_map.o trajectory_list_bins.o n_fold_order_parameter.o composition.o structure_factor.o clustered_list.o vector_autocorrelation.o trajectory_list_decay.o stiffness_dist.o error.o mean_displacement.o multibody.o multibody_set.o multibody_list.o multibody_analysis.o gyration_radius.o trajectory_set.o edge_detector_timedependent.o mean_velocity_unsteady.o mean_unsteady_displacement.o analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o displacement_list.o \
	orientational_correlation.o multibody_region.o comover_multibodies.o size_statistics.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o relative_displacement_strings.o neighbor_list.o distance_neighbor_list.o