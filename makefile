...
analysis_onetime.o radial_distribution_function.o bond_autocorrelation_function.o displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o
...
orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o
	$(CXX) $(CFLAGSmain) amdat.o tokenize.o coordinate.o trajectory.o atom_trajectory.o molecule.o system.o analysis.o space-time_correlation_function.o van_hove_self.o progress.o mean_square_displacement.o van_hove_distinct.o control.o wave_vectors.o wave_density.o intermediate_scattering_function.o correlation_2d.o incoherent_scattering_function.o debyewaller_dist.o stiffness_dist.o non_gaussian_parameter.o gaussian_comparison.o radial_debye_waller.o mean_square_displacement_2d.o velocity_autocorrelation.o strings.o trajectory_list.o  static_trajectory_list.o clustered_list.o exptime_trajectory_list.o rgtensor.o trajmath.o rgtensor_stats.o \
	...
	displacement_list.o orientational_correlation.o size_statistics.o multibody_region.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o comover_multibodies.o relative_displacement_strings.o -o AMDAT -lfftw3 -lm 
...
clean: 
	...
	orientational_correlation.o multibody_region.o comover_multibodies.o size_statistics.o provisional_multibodies.o dynamic_cluster_multibodies.o string_multibodies.o relative_displacement_strings.o
