...
$(OBJDIR)/vector_autocorrelation.o $(OBJDIR)/error.o $(OBJDIR)/mean_displacement.o $(OBJDIR)/multibody.o $(OBJDIR)/multibody_set.o $(OBJDIR)/multibody_list.o $(OBJDIR)/multibody_analysis.o $(OBJDIR)/endtoend_distance.o $(OBJDIR)/gyration_radius.o $(OBJDIR)/trajectory_set.o $(OBJDIR)/edge_detector_timedependent.o $(OBJDIR)/mean_velocity_unsteady.o \
...
src/bin_static_analysis.h src/composition.h src/composition_timedependent.h src/n_fold_order_parameter.h src/trajectory_list_decay.h src/multibody_set.h src/multibody.h src/multibody_list.h src/multibody_analysis.h src/endtoend_distance.h src/gyration_radius.h src/trajectory_set.h src/edge_detector_timedependent.h \
...
$(OBJDIR)/endtoend_distance.o: src/endtoend_distance.cpp src/endtoend_distance.h src/multibody_analysis.h src/multibody_list.h src/system.h src/molecule.h src/analysis.h src/atom_trajectory.h src/coordinate.h src/tokenize.h src/trajectory.h src/multibody.h src/multibody_set.h src/version.h
